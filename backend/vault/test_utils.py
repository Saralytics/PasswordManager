...
class TestPasswordGenerator(TestCase):
    ...
    def test_length(self):
        ...
        self.assertEqual(len(password), self.generator.password_len, "The password length does not match the expected value.")
    ...
    def test_composition(self):
        ...
        symbol_count = len(password) - digit_count - upper_letter_count - lower_letter_count

        self.assertEqual(digit_count, self.generator.counts['nbr_digits'], "The number of digits in the password is incorrect.")
        self.assertEqual(upper_letter_count, self.generator.counts['nbr_upper'], "The number of letters in the password is incorrect.")
        self.assertEqual(lower_letter_count, self.generator.counts['nbr_lower'], "The number of letters in the password is incorrect.")
        self.assertEqual(symbol_count, self.generator.counts['nbr_symbols'], "The number of symbols in the password is incorrect.")
    ...
    def test_randomness(self):
        ...
        self.assertTrue(len(passwords) > 99, "Generated passwords lack randomness")
    ...
    def test_configuration_output(self):
        ...
        generator = PasswordGenerator(has_digits="True", has_upper_case="False", has_lower_case="False", has_symbols="False")
        password = generator.generate()
        self.assertTrue(password.isdigit(), "Generated password does not match the digit-only configuration.")
    ...
    def test_minimum_length(self):
        ...
        password = self.generator.generate()
        self.assertEqual(len(password), MIN_PASS_LEN, "Password does not meet the minimum length requirement.")

    def test_maximum_length(self):
        """Ensure password does not exceed the maximum length requirement."""
        self.generator.password_len = MAX_PASS_LEN
        password = self.generator.generate()
        self.assertEqual(len(password), MAX_PASS_LEN, "Password exceeds the maximum length requirement.")
    ...
    def test_unique_configurations(self):
        ...
        self.generator = PasswordGenerator(has_upper_case="False", has_lower_case="False", has_digits="True", has_symbols="False")
        password = self.generator.generate()
        self.assertTrue(password.isdigit(), "Password should contain only digits.")
    ...
    def test_password_strength(self):
        ...
        password = self.generator.generate()
        self.assertTrue(any(char.isdigit() for char in password), "Password lacks digits.")
        self.assertTrue(any(char.isupper() for char in password), "Password lacks uppercase letters.")
